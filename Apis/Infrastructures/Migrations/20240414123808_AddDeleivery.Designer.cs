...
namespace Infrastructures.Migrations
{
    ...
    [Migration("20240414123808_AddDeleivery")]
    partial class AddDeleivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BaseTask", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("BaseTask");
            ...
            modelBuilder.Entity("Domain.Entities.DeliveryImage", b =>
                {
                    b.HasBaseType("Domain.Entities.BaseTask");
                    ...
                    b.HasDiscriminator().HasValue("DeliveryImage");
                });
