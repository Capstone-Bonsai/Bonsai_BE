...
namespace Application.Commons
{
    public class MailService
    {
        public bool SendEmail(string toMail, string subject, string content)
        {
            ...
            email.From.Add(new MailboxAddress("Thạch Sơn Garden", "tramygeo@gmail.com"));
            ...
            builder.HtmlBody = "<div style=\"font-family: 'Arial', sans-serif;\r\nbackground-color: #f4f4f4;\r\nmargin: 0;\r\npadding: 0;\r\ndisplay: flex;" +
                ...
                " text-align: left;\">Trân trọng,</p>\r\n    <p style=\"font-weight: bold; color: #009c11;\">Thạch Sơn Garden</p>\r\n  " +
                ...
                "  alt=\"Logo Thạch Sơn Garden\">  <div style=\"margin-top: 20px;\r\n    text-align: left;\">\r\n    " +
                "  <p style=\"margin-bottom: 10px;\r\n text-align: left; margin: 5px 0;  color: #009c11;\"><strong>Liên hệ với chúng tôi để được hỗ trợ nhiều\r\n hơn</strong>" +
                "</p>\r\n <p style=\"margin-bottom: 10px;\r\n text-align: left; margin: 5px 0;\"><strong>Email:</strong> hotro@thachson.vn</p>\r\n " +
