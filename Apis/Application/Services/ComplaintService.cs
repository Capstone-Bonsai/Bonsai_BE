...
namespace Application.Services
{
    public class ComplaintService : IComplaintService
    {
        ...
        public async Task CreateComplaint(string userId, ComplaintModel model)
        {
            ...
            if (serviceOrder.ServiceOrderStatus == Domain.Enums.ServiceOrderStatus.TaskFinished || serviceOrder.ServiceOrderStatus == Domain.Enums.ServiceOrderStatus.DoneTaskComplaint || serviceOrder.ServiceOrderStatus == Domain.Enums.ServiceOrderStatus.ComplaintCanceled) { }else throw new Exception("Đơn đặt hàng dịch vụ này đang được xử lý nên không thể gửi khiếu nại.");
